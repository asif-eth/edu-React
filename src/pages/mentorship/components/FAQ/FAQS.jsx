...
const FAQS = () => {
        ...
        const questions =  [
                {
                  question: 'Q1.I have an upcoming interview. Can I take this long-term mentorship package?',
                ...
                {
                  question: 'Q3. What are the advantages of interview preparation through mentorship?',
                ...
                {
                  question: 'Q4.What does mentorship till you get your dream job mean?',
        ...
        return (
          <div >
            <div>
              <h1 className='text-2xl text-center md:text-5xl text-blue font-bold flex justify-center mb-6 mt-12'>Frequently Asked <span className='text-pink ml-2'>Questions</span></h1>
            </div>
