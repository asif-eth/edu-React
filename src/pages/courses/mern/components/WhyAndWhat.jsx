                                                ...
                                                <div className='pl-1 md:pl-0'>
                                                        <div className='flex gap-x-3'>
                                                                ...
                                                                <div>
                                                                        ...
                                                                        <p className="mt-1 md:mt-2 text-gray">Mark Zuckerberg built Facebook. Sachin Bansal built Flipkart. What will you build?</p>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div className='flex gap-x-3'>
                                                                ...
                                                                <div>
                                                                        ...
                                                                        <p className="mt-1 md:mt-2 text-gray">With 1.7 billion websites on the internet, it is one of the hottest career options with an average fresher salary of 6 LPA for full stack developers according to Glassdoor.</p>
                                                                </div>
                                                        </div>
